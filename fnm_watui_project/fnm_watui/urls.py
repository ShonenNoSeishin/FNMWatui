...
urlpatterns = [
    ...
    path("modify_flowspec_route/<int:flowspec_id>", views.modify_flowspec_route, name="modify_flowspec_route"),
    ...
    path('set_flex_thresh/', views.set_flex_thresh, name='set_flex_thresh'),
